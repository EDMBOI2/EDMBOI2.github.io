...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-04-2024 a las 03:33:46
...
--
-- Estructura de tabla para la tabla `tnl_banners`
--

CREATE TABLE `tnl_banners` (
  `ID` int(11) NOT NULL,
  `titulo` varchar(255) NOT NULL,
  `descripcion` varchar(255) NOT NULL,
...
--
-- Indices de la tabla `tnl_banners`
--
ALTER TABLE `tnl_banners`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT de la tabla `tnl_banners`
--
ALTER TABLE `tnl_banners`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
